...
class Summoning(Cog_Extension):
    ...
    async def on_message(self, msg):
        ...
        channel1 = self.bot.get_channel(os.environ.get('CHANNEL_SUMMONROOM_FROM_4700'))  ##4700 抽卡區
        channel2 = self.bot.get_channel(os.environ.get('CHANNEL_SUMMONROOM_FROM_DISH'))  ##餐廳 曬卡區
